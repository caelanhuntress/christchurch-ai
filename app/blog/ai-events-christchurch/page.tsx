    ...
    <div className="min-h-screen" style={{ background: "var(--background)" }}>
      ...
      <article className="max-w-2xl mx-auto px-6 py-20">
        ...
        <div className="space-y-6 text-base leading-relaxed" style={{ color: "var(--text-muted)" }}>
          ...
          <h2 className="text-2xl font-bold mt-10 mb-4" style={{ color: "#004aad" }}>Christchurch AI — Monthly Meetup</h2>
          ...
          <h2 className="text-2xl font-bold mt-10 mb-4" style={{ color: "#004aad" }}>TechWeek NZ — Christchurch Programme</h2>
          ...
          <h2 className="text-2xl font-bold mt-10 mb-4" style={{ color: "#004aad" }}>Canterbury Tech Events</h2>
          ...
          <h2 className="text-2xl font-bold mt-10 mb-4" style={{ color: "#004aad" }}>Global AI Bootcamp — Christchurch</h2>
          ...
          <h2 className="text-2xl font-bold mt-10 mb-4" style={{ color: "#004aad" }}>University of Canterbury — AI Research Events</h2>
          ...
          <h2 className="text-2xl font-bold mt-10 mb-4" style={{ color: "#004aad" }}>Online Events with a Christchurch Community</h2>
          ...
          <h2 className="text-2xl font-bold mt-10 mb-4" style={{ color: "#004aad" }}>How to Stay Updated</h2>
